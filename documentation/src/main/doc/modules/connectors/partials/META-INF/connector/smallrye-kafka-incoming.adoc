...
| *cloud-events* | Enables (default) or disables the Cloud Event support. If enabled, the connector analyze the incoming records and try to create Cloud Event metadata.

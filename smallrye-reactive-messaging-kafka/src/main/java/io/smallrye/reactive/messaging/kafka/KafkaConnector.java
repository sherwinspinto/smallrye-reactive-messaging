...
@ConnectorAttribute(name = "cloud-events", type = "boolean", direction = Direction.INCOMING, description = "Enables (default) or disables the Cloud Event support. If enabled, the connector analyze the incoming records and try to create Cloud Event metadata.", defaultValue = "true")
